    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col">
        ...
        <div className="px-5 py-3 border-b border-gray-100 bg-gray-50/60 flex items-center gap-4 flex-shrink-0">
          <label className="text-xs font-semibold text-gray-600 whitespace-nowrap">Bank / Cash Ledger *</label>
            ...
            <thead className="sticky top-0 z-10 bg-gray-50 border-b border-gray-200">
              <tr>
                ...
                <th className="px-2 py-2.5 text-right font-semibold text-gray-600 whitespace-nowrap">
                  Debit<br /><span className="font-normal text-gray-400">(Bank Cr)</span>
                </th>
                <th className="px-2 py-2.5 text-right font-semibold text-gray-600 whitespace-nowrap">
                  Credit<br /><span className="font-normal text-gray-400">(Bank Dr)</span>
                </th>
