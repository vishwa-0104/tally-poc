  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose-custom space-y-10 text-gray-300 text-sm leading-relaxed">

          <section>
            <h2>1. Introduction</h2>
            <p>
              Welcome to <span className="text-teal-400">https://www.invoiceSync.nextax.in</span> ("we," "us," or "our"), a product of <strong className="text-white">Nextax Technologies Private Limited</strong>. We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you use our website and services.
            </p>
          ...
          <section>
            ...
            <ul>
              <li><strong className="text-white">Personal Information:</strong> Name, email address, phone number, postal address, and other contact details</li>
              <li><strong className="text-white">Account Information:</strong> Username, password, and account preferences when you register for an account</li>
              <li><strong className="text-white">Documents:</strong> Bills, invoices, receipts, and other documents you upload for parsing</li>
              <li><strong className="text-white">Communication Data:</strong> Information you provide when contacting us via email, forms, or other channels</li>
            </ul>
          ...
          <section>
            ...
            <ul>
              <li><strong className="text-white">Service Delivery:</strong> To provide, maintain, and improve our services</li>
              <li><strong className="text-white">Bill Parsing:</strong> To process your documents using AI technology for data extraction</li>
              ...
              <li><strong className="text-white">Analytics:</strong> To understand how you use our website and improve user experience</li>
              <li><strong className="text-white">Security:</strong> To detect, prevent, and address technical issues and security threats</li>
              <li><strong className="text-white">Legal Compliance:</strong> To comply with applicable laws</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul>
              <li><strong className="text-white">Transmission to AI Services:</strong> Your documents are sent to the mentioned AI services for processing</li>
              <li><strong className="text-white">Data Handling:</strong> These AI models process this data in accordance with their own Privacy Policies. We recommend reviewing their documentation to understand their data handling practices</li>
              <li><strong className="text-white">We Do Not Store Parsed Data:</strong> After processing is complete and results are returned, we do not retain, store, or archive your parsed bill information in our database</li>
              <li><strong className="text-white">Temporary Processing:</strong> Any data processed through our servers is held only temporarily for the duration of the AI request</li>
            </ul>
      ...
      {/* Footer */}
      <footer className="py-8 px-6 bg-gray-950 border-t border-white/5 mt-8">
