    ...
    <div className="flex-1 p-5">
      ...
      {loaded ? (
        ...
        <div
          ...
          className="rounded-xl border-2 border-dashed border-gray-200 hover:border-violet-400 bg-gray-50/50 hover:bg-violet-50/30 transition-colors cursor-pointer px-4 py-6 flex flex-col items-center gap-1.5 text-gray-400 hover:text-violet-600"
        >
        ...
        {(showUpload || records.length === 0) && (
          <div className="card overflow-hidden">
            <div className="px-5 py-3 border-b border-gray-100 flex items-center justify-between">
              <h2 className="text-sm font-semibold text-gray-700">New Vendor Reconciliation</h2>
              {records.length > 0 && (
            ...
            <div className="border-t border-gray-100 px-5 py-4 flex justify-center">
              <Button variant="teal" size="sm" disabled={!stmtMy || !stmtVendor || parsingMy || parsingVendor} onClick={handleReconcile}>
                ...
                <table className="w-full text-xs">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-100">
                      {['My Ledger', 'Vendor Ledger', 'Created', 'Matched', 'Missing', 'Extra', ''].map((h, i) => (
