        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-border flex-shrink-0">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-bold text-foreground">Bank Reconciliation Statement</span>
            </div>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          ...
          <div className="mb-5 rounded-lg border border-border overflow-hidden bg-card">
            ...
            <div className="text-center py-2.5 border-b border-border">
              <span className="text-sm font-semibold text-foreground tracking-wide">Bank Reconciliation Statement</span>
            </div>
  ...
  if (!record) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-3 text-muted-foreground">
        ...
        <button onClick={() => navigate('/company/reconcile')} className="text-xs text-primary hover:underline">
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <CompanyPageHeader
        ...
        actions={
          <Button variant="outline" size="sm" onClick={() => navigate('/company/reconcile')}>
                  ...
                  <td className="px-3 py-2.5">
                    <div className="flex items-center gap-1.5">
                      ...
                      <div className="flex flex-col gap-0.5 min-w-0">
                        {row.source === 'bank' ? (
                          <Badge variant="secondary" className="w-fit">From Bank</Badge>
                        ) : (
                          <Badge variant="outline" className="w-fit border-primary/30 text-primary">From Books</Badge>
                        )}
