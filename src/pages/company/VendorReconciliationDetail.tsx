        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 flex-shrink-0">
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-bold text-gray-900">Vendor Reconciliation Statement</span>
            </div>
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4">
          ...
          <div className="mb-5 rounded-lg border border-gray-300 overflow-hidden bg-white">
            <div className="text-center py-2.5 border-b border-gray-200">
              <span className="text-sm font-semibold text-gray-800 tracking-wide">Vendor Reconciliation Statement</span>
            </div>
            ...
            <table className="w-full border-collapse table-fixed text-sm">
              ...
              <tbody>
                ...
                <tr className="border-t-2 border-gray-800 bg-gray-900">
                  ...
                  <td />
                  <td className="px-4 py-3 text-right text-sm font-bold tabular-nums whitespace-nowrap text-violet-400">
                    {formatCurrency(vendorBalance)}
                  </td>
                </tr>
        ...
        <div className="flex items-center justify-between px-5 py-3 border-t border-gray-100 flex-shrink-0 bg-gray-50/60">
          {missingRows.length > 0 ? (
            <button
              ...
              className="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-lg border border-violet-200 text-violet-700 bg-violet-50 hover:bg-violet-100 transition-colors"
            >
              Add missing entries in Book
              <span className="ml-1 px-1.5 py-0.5 rounded-full bg-violet-200 text-violet-700 text-[10px] font-bold">
                {missingRows.length}
              </span>
            </button>
          ) : <span />}
...
export default function VendorReconciliationDetail() {
  ...
  if (!record) {
    return (
      <div className="flex flex-col items-center justify-center h-full gap-3 text-gray-400">
        ...
        <button onClick={() => navigate('/company/vendor-reconcile')} className="text-xs text-violet-600 hover:underline">
  ...
  const SummaryBtn = () => (
    <button
      ...
      className="flex items-center gap-1.5 text-xs font-medium px-3 py-1.5 rounded-lg border transition-colors bg-violet-600 text-white border-violet-600 hover:bg-violet-700"
    >
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden">
      ...
      <div className="flex items-center gap-3 px-6 py-3 border-b border-gray-100 bg-white flex-shrink-0">
        <button
          onClick={() => navigate('/company/vendor-reconcile')}
                  ...
                  <td className="px-3 py-2.5">
                    <div className="flex items-center gap-1.5">
                      ...
                      <div className="flex flex-col gap-0.5 min-w-0">
                        {row.source === 'bank' ? (
                          <span className="inline-block px-2 py-0.5 rounded-full text-[10px] font-medium bg-sky-100 text-sky-700 w-fit">My Ledger</span>
                        ) : (
                          <span className="inline-block px-2 py-0.5 rounded-full text-[10px] font-medium bg-violet-100 text-violet-700 w-fit">Vendor Ledger</span>
                        )}
