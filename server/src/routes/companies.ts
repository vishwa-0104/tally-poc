...
companiesRouter.put('/companies/:id/dashboard-settings', async (req, res) => {
  ...
  const schema = z.object({
    ...
    ytd: z.object({
      ...
      currentRatioAssetsLedgers:      z.array(z.string()).optional(),
      currentRatioLiabilitiesLedgers: z.array(z.string()).optional(),
      quickRatioAssetsLedgers:        z.array(z.string()).optional(),
      quickRatioLiabilitiesLedgers:   z.array(z.string()).optional(),
