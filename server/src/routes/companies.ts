...
companiesRouter.put('/companies/:id/dashboard-settings', async (req, res) => {
  ...
  const schema = z.object({
    ...
    ytd: z.object({
      ...
      dioPurchaseAccounts:        z.array(z.string()).optional(),
      dioPurchaseIncludeVouchers: z.array(z.string()).optional(),
      dioPurchaseExcludeVouchers: z.array(z.string()).optional(),
      dioDirectExpenseLedgers:    z.array(z.string()).optional(),
      dpoPurchaseAccounts:        z.array(z.string()).optional(),
      dpoPurchaseIncludeVouchers: z.array(z.string()).optional(),
      dpoPurchaseExcludeVouchers: z.array(z.string()).optional(),
      ...
      longTermBorrowingLedgers:       z.array(z.string()).optional(),
      equityLedgers:                  z.array(z.string()).optional(),
      roeEquityLedgers:               z.array(z.string()).optional(),
      internalBorrowingLedgers:       z.array(z.string()).optional(),
      intangibleAssetLedgers:         z.array(z.string()).optional(),
      debtEquityLoanLedgers:          z.array(z.string()).optional(),
      debtEquityCashLedgers:          z.array(z.string()).optional(),
      debtEquityBankLedgers:          z.array(z.string()).optional(),
      debtEquityEquityLedgers:        z.array(z.string()).optional(),
      currentRatioAssetsGroups:      z.array(z.string()).optional(),
      currentRatioLiabilitiesGroups: z.array(z.string()).optional(),
      quickRatioAssetsGroups:        z.array(z.string()).optional(),
      quickRatioLiabilitiesGroups:   z.array(z.string()).optional(),
      dsoDaysMode: z.enum(['ytd', '365']).optional(),
      dioDaysMode: z.enum(['ytd', '365']).optional(),
      dpoDaysMode: z.enum(['ytd', '365']).optional(),
      dsoUseManualOpeningDebtors:   z.boolean().optional(),
      dsoManualOpeningDebtors:      z.number().optional(),
      dioUseManualOpeningStock:     z.boolean().optional(),
      dioManualOpeningStock:        z.number().optional(),
      dpoUseManualOpeningCreditors: z.boolean().optional(),
      dpoManualOpeningCreditors:    z.number().optional(),
...
companiesRouter.put('/companies/:id/dashboard-snapshot', async (req, res) => {
  ...
  const schema = z.object({
    ...
    dioDirectExpenseTotal: z.number().nullable().optional(),
    ...
    longTermBorrowings: z.number().nullable().optional(),
    roceEquity:         z.number().nullable().optional(),
    roeEquity:          z.number().nullable().optional(),
    internalBorrowings: z.number().nullable().optional(),
    intangibleAssets:   z.number().nullable().optional(),
    debtEquityLoans:    z.number().nullable().optional(),
    debtEquityCash:     z.number().nullable().optional(),
    debtEquityBank:     z.number().nullable().optional(),
    debtEquityEquity:   z.number().nullable().optional(),
    currentRatioAssetsTotal:      z.number().nullable().optional(),
    currentRatioLiabilitiesTotal: z.number().nullable().optional(),
    quickRatioAssetsTotal:        z.number().nullable().optional(),
    quickRatioLiabilitiesTotal:   z.number().nullable().optional(),
